...
const WhatsAppButton = () => {
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#0B1C2D] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(212,175,55,0.5)] border border-[#D4AF37]/30 transition-shadow cursor-pointer group"
            aria-label="Chat on WhatsApp"
        >
            {/* WhatsApp Icon SVG */}
            <svg
                viewBox="0 0 24 24"
                className="w-8 h-8 fill-[#D4AF37] group-hover:fill-[#F5C15D] transition-colors"
            ...
            {/* Pulsing Ring Effect */}
            <div className="absolute inset-0 rounded-full border border-[#D4AF37] opacity-0 group-hover:animate-ping" />
        </motion.a>
    );
};
